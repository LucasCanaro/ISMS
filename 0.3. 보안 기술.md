...
2. [보안 설정](#2-보안-설정)
3. [보안 규칙 적용 방식](#3-보안-규칙-적용-방식)
4. [linux 접근 제어](#4-linux-접근-제어)
    4.1. [4-1 shadow file](#4-1-etcshadow-file)
    4-2. [4-2 pam](#4-2-pam---linux-application-권한-제어)
...
### 4-2 PAM - linux application 권한 제어
